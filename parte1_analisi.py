...
class Config:
    ...
    # Override ruoli errati nel DB
    ruolo_override: dict[str, str] = field(default_factory=lambda: {
        # ── ATTACCANTI
        "Adam Buksa": "ATT",
        "Ademola Lookman": "ATT",
        "Adrian Benedyczak": "ATT",
        "Adrien Rabiot": "CEN",
        "Albert Gudmundsson": "ATT",
        "Alieu Njie": "ATT",
        "Alisson Santos": "ATT",
        "Alvaro Morata": "ATT",
        "Andrea Belotti": "ATT",
        ...
        "Armand Lauriente": "ATT",
        "Artem Dovbyk": "ATT",
        "Boulaye Dia": "ATT",
        "Caleb Ekuban": "ATT",
        "Cesare Casadei": "ATT",
        "Che Adams": "ATT",
        "Christian Pulisic": "ATT",
        "Christopher Nkunku": "ATT",
        "Cyril Ngonge": "ATT",
        "David Neres": "ATT",
        "Davide Frattesi": "CEN",
        "Dennis Johnsen": "ATT",
        "Domenico Berardi": "ATT",
        "Donyell Malen": "ATT",
        "Dusan Vlahovic": "ATT",
        "Duvan Zapata": "ATT",
        "Edoardo Iannoni": "ATT",
        "Evan Ferguson": "ATT",
        "Faris Moumbagna": "ATT",
        "Federico Bernardeschi": "ATT",
        "Federico Bonazzoli": "ATT",
        "Federico Dimarco": "DIF",
        "Felipe Loyola": "ATT",
        "Filip Kostic": "CEN",
        "Francesco Camarda": "ATT",
        "Francesco Pio Esposito": "ATT",
        "Francisco Conceicao": "ATT",
        "Franck Zambo": "ATT",
        "Franco Vazquez": "ATT",
        "Gabriele Piccinini": "ATT",
        "Gaetano Oristanio": "ATT",
        "Gennaro Borrelli": "ATT",
        "Giacomo Raspadori": "ATT",
        "Gianluca Scamacca": "ATT",
        "Gift Orban": "ATT",
        "Giorgio Scalvini": "ATT",
        "Giovanni Fabbian": "CEN",
        "Giovanni Simeone": "ATT",
        "Gustav Isaksen": "ATT",
        ...
        "Jens Odgaard": "ATT",
        "Jeremie Boga": "ATT",
        "Jonathan Christian David": "ATT",
        "Jonathan Rowe": "ATT",
        "Juan Cabal": "DIF",
        "Juan Cuadrado": "ATT",
        "Junior Messias": "ATT",
        "Kamaldeen Sulemana": "ATT",
        "Keinan Davis": "ATT",
        "Kenan Yildiz": "ATT",
        "Kevin De Bruyne": "ATT",
        "Kieron Bowie": "ATT",
        ...
        "Lorenzo Colombo": "ATT",
        "Lorenzo Lucca": "ATT",
        "Lorenzo Pellegrini": "CEN",
        "Lorran": "ATT",
        "Luca Mazzitelli": "CEN",
        "Luca Moro": "ATT",
        "MBala Nzola": "ATT",
        "Manor Solomon": "ATT",
        "Marc-Oliver Kempf": "ATT",
        "Marco Brescianini": "ATT",
        "Marcus Thuram": "ATT",
        "Martin Baturina": "ATT",
        "Mateo Pellegrino": "ATT",
        "Matias Soule Malvano": "ATT",
        ...
        "Roberto Piccoli": "ATT",
        "Robinio Vaz": "ATT",
        "Rolando Mandragora": "CEN",
        "Ruben Loftus-Cheek": "CEN",
        "Ruslan Malinovskiy": "ATT",
        "Santiago Castro": "ATT",
        "Santiago Gimenez": "ATT",
        "Scott McTominay": "CEN",
        "Semih Kilicsoy": "ATT",
        "Stefan Posch": "DIF",
        "Stefano Moreo": "ATT",
        "Stephan El Shaarawy": "ATT",
        "Tasos Douvikas": "ATT",
        "Thijs Dallinga": "ATT",
        "Tijjani Noslin": "ATT",
        "Vakoun Bayo": "ATT",
        "Valentin Castellanos": "ATT",
        "Vasilije Adzic": "ATT",
        "Vitinha": "ATT",
        "Walid Cheddira": "ATT",
        "Weston McKennie": "CEN",
        "Zachary Athekame": "ATT",
        "Zito": "ATT",
        # ── CENTROCAMPISTI
        "Aaron Martin": "DIF",
        "Adam Masina": "DIF",
        ...
        "Ardon Jashari": "CEN",
        "Arthur Atta": "CEN",
        "Benjamin Dominguez": "CEN",
        "Bremer": "CEN",
        "Bryan Zaragoza": "CEN",
        "Charalampos Lykogiannis": "DIF",
        "Charles De Ketelaere": "CEN",
        "Cristian Volpato": "CEN",
        "Daniel Maldini": "ATT",
        "Daniel Mosquera": "CEN",
        "Danilo Cataldi": "CEN",
        "Davide Bartesaghi": "CEN",
        ...
        "Jesus Rodriguez": "CEN",
        "Juan Miranda": "CEN",
        "Kristian Thorstvedt": "CEN",
        "Leonardo Spinazzola": "CEN",
        "Lorenzo Bernasconi": "CEN",
        ...
        "Alessandro Buongiorno": "DIF",
        "Alessandro Circati": "DIF",
        "Alessandro Deiola": "DIF",
        "Alessandro Di Pardo": "DIF",
        "Alessandro Marcandalli": "DIF",
        "Alessandro Zanoli": "DIF",
        "Alessio Romagnoli": "DIF",
        "Alex Amorim": "DIF",
        "Alex Meret": "DIF",
        "Alex Valle": "DIF",
        "Amin Sarr": "DIF",
        "Amir Rrahmani": "DIF",
        "Andrias Edmundsson": "ATT",
        "Angelino": "DIF",
        "Antoine Bernede": "DIF",
        "Antonino Gallo": "DIF",
        "Antonio Caracciolo": "DIF",
        "Ardian Ismajli": "DIF",
        "Armel Bella Kotchap": "DIF",
        "Arturo Calabresi": "DIF",
        "Assane Diao": "ATT",
        "Aster Vranckx": "CEN",
        ...
        "Cheikh Niasse": "DIF",
        "Cher Ndour": "CEN",
        "Christian Kabasele": "DIF",
        "Christian Ordonez": "DIF",
        "Ciro Immobile": "ATT",
        "Corrie Ndaba": "DIF",
        "Cristiano Biraghi": "DIF",
        "Daniel Boloca": "CEN",
        "Daniel Oyegoke": "DIF",
        "Daniele Ghilardi": "DIF",
        "Danilo Veiga": "DIF",
        "Devyne Rensch": "DIF",
        "Diego Carlos": "DIF",
        "Dodo": "DIF",
        "Domagoj Bradaric": "DIF",
        "Ebenezer Akinsanmiro": "DIF",
        "Ederson": "DIF",
        "Edin Dzeko": "ATT",
        "Edoardo Motta": "DIF",
        "Eljif Elmas": "CEN",
        "Emirhan Ilkhan": "DIF",
        "Enrico Del Prato": "DIF",
        "Enzo Ebosse": "DIF",
        "Evan Ndicka": "DIF",
        "Fabiano Parisi": "DIF",
        "Fali Cande": "DIF",
        "Faustino Anjorin": "DIF",
        "Federico Baschirotto": "DIF",
        "Federico Ceccherini": "DIF",
        "Federico Gatti": "DIF",
        "Fikayo Tomori": "DIF",
        "Filip Stojilkovic": "DIF",
        "Filippo Romagna": "DIF",
        "Filippo Terracciano": "DIF",
        "Fisayo Dele-Bashiru": "CEN",
        "Francesco Acerbi": "DIF",
        "Francesco Coppola": "DIF",
        "Francesco Folino": "DIF",
        "Gabriel Strefezza": "ATT",
        "Gabriele Zappa": "DIF",
        "Gianluca Mancini": "DIF",
        "Giovanni Bonfanti": "DIF",
        "Giovanni Di Lorenzo": "DIF",
        "Giuseppe Pezzella": "DIF",
        ...
        "Jacobo Ramon": "DIF",
        "Jacopo Fazzini": "CEN",
        "Jakub Piotrowski": "CEN",
        "Jamil Siebert": "DIF",
        "Jean-Daniel Akpa-Akpro": "DIF",
        "Jeremy Sarmiento": "DIF",
        "Jesper Karlstrom": "DIF",
        "Jhon Lucumi": "DIF",
        "Joao Mario": "DIF",
        "Johan Vasquez": "DIF",
        "Jordan Zemura": "DIF",
        ...
        "Juan Jesus": "DIF",
        "Juan Rodriguez": "DIF",
        "Jurgen Ekkelenkamp": "DIF",
        "Kenneth Taylor": "DIF",
        "Kephren Thuram": "DIF",
        "Kialonda Gaspar": "DIF",
        "Kingsley Ehizibue": "DIF",
        "Koni de Winter": "DIF",
        "Konstantinos Tsimikas": "DIF",
        "Kouadio Kone": "DIF",
        "Kristjan Asllani": "CEN",
        "Lassana Coulibaly": "DIF",
        "Lautaro Valenti": "DIF",
        "Lennon Miller": "DIF",
        "Leo Ostigard": "DIF",
        "Leon Bailey": "DIF",
        ...
        "Mathias Lovik": "DIF",
        "Mathias Olivera": "DIF",
        "Matteo Bianchetti": "DIF",
        "Matteo Gabbia": "DIF",
        "Matteo Guendouzi": "CEN",
        "Matteo Prati": "DIF",
        "Mattia Zaccagni": "CEN",
        "Mehmet Zeki Celik": "DIF",
        "Michael Folorunsho": "CEN",
        "Michel Aebischer": "CEN",
        "Michele Collocolo": "DIF",
        "Miguel Gutierrez": "DIF",
        "Mikael Ellertsson": "DIF",
        "Mohamed Kaba": "DIF",
        "Morten Frendrup": "CEN",
        "Nadir Zortea": "DIF",
        "Nahuel Estevez": "CEN",
        ...
        "Santiago Pierotti": "DIF",
        "Sascha Britschgi": "DIF",
        "Saul Coco": "DIF",
        "Sead Kolasinac": "DIF",
        "Sebastian Otoa": "DIF",
        "Sebastian Walukiewicz": "DIF",
        "Sebastiano Luperto": "DIF",
        "Sergi Roberto": "DIF",
        "Simone Canestrelli": "DIF",
        "Stanislav Lobotka": "CEN",
        "Stefan de Vrij": "DIF",
        "Stefano Sabelli": "DIF",
        "Strahinja Pavlovic": "DIF",
        "Suat Serdar": "CEN",
        "Sulemana": "DIF",
        "Tarik Muharemovic": "DIF",
        "Tete Morente": "DIF",
        "Teun Koopmeiners": "CEN",
        "Thomas Thiesson Kristensen": "DIF",
        "Thorir Helgason": "DIF",
        "Tiago Gabriel": "DIF",
        "Tobias Slotsager": "DIF",
        "Toma Basic": "CEN",
        "Tommaso Baldanzi": "CEN",
        "Tommaso Barbieri": "DIF",
        "Tommaso Pobega": "CEN",
        "Torbjorn Heggem": "DIF",
        "Unai Nunez": "DIF",
        "Valentin Carboni": "CEN",
        ...
        "Wladimiro Falcone": "POR",
        "Yann Sommer": "POR",
        "Zion Suzuki": "POR",
        # ── Correzioni aggiuntive da fonti esterne
        "Martín Payero": "CEN",
        "Valentín Carboni": "CEN",
        "Idrissa Touré": "CEN",
        "Albert Grønbæk": "CEN",
        "Nahuel Estévez": "CEN",
        "Aarón Martín": "DIF",
        ...
        # ── Correzioni da Transfermarkt + Wikipedia + Fantacalcio + Goal ──
        # ATT → DIF
        "Giorgio Scalvini": "DIF",      # difensore centrale Atalanta (TM: Difensore)
        # ATT → CEN
        "Scott McTominay": "CEN",       # mezzala Napoli
        "Weston McKennie": "CEN",       # mezzala Juventus
        "Henrikh Mkhitaryan": "CEN",    # mezzala Inter
        "Lorenzo Pellegrini": "CEN",    # trequartista Roma
        "Nikola Vlasic": "CEN",         # trequartista Torino
        "Hakan Calhanoglu": "CEN",      # regista Inter
        "Giovanni Fabbian": "CEN",      # mezzala Bologna
        "Morten Thorsby": "CEN",        # mediano Cremonese/Genoa
        "Martin Baturina": "CEN",       # mezzala Como
        "Ruslan Malinovskiy": "CEN",    # trequartista Genoa
        "Kevin De Bruyne": "CEN",       # regista Napoli
        "Franco Vazquez": "CEN",        # trequartista Cremonese
        "Franco Vázquez": "CEN",
        # CEN → DIF
        "Pierre Kalulu Kyatengwa": "DIF",  # difensore centrale Juventus (Wikipedia: DIF)
        "Bremer": "DIF",                   # difensore centrale Juventus
        "Davide Bartesaghi": "DIF",        # terzino sinistro Milan
        "Juan Miranda": "DIF",             # terzino sinistro Bologna
        "Emil Holm": "DIF",                # terzino Atalanta/Spezia
        # CEN → ATT
        "Wesley": "ATT",               # ala destra Roma (Transfermarkt: Ala)
        "Sebastiano Esposito": "ATT",  # centravanti Empoli/Cagliari
        "Riccardo Sottil": "ATT",      # ala Fiorentina/Lecce
        "Alieu Fadera": "ATT",         # ala Como/Sassuolo
        # DIF → CEN
        "Ederson": "CEN",              # centrocampista Atalanta (TM: Centrocampista)
        "Kenneth Taylor": "CEN",       # centrocampista Lazio (Wikipedia: CEN)
        "Lassana Coulibaly": "CEN",    # centrocampista Lecce
        "Youssef Maleh": "CEN",        # mezzala Cremonese
        "Kephren Thuram": "CEN",       # centrocampista Juventus
        "Luis Henrique": "ATT",        # ala Inter (Transfermarkt: Ala sinistra)
        # DIF → POR
        "Alex Meret": "POR",           # portiere Napoli!
        # DIF → ATT
        "Mattia Zaccagni": "ATT",      # ala sinistra Lazio (Fantacalcio: ATT)
        "Ciro Immobile": "ATT",        # centravanti Lazio/Bologna
        "Edin Dzeko": "ATT",           # centravanti Fiorentina/vari
        "Gabriel Strefezza": "ATT",    # ala Como/Lecce
        "Assane Diao": "ATT",          # ala Como
        "Jack Harrison": "ATT",        # ala Everton/Fiorentina
